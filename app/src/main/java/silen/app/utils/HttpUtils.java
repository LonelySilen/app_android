        ...
        try
        {
            ...
            if (conn.getResponseCode() == 200)
            {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    JSONObject jsonObject2 = jsonObject1.getJSONObject("attrs");
                    Log.i("test", jsonObject2.getInt("BUYER_ID")+"");
                    Log.i("test", jsonObject2.getInt("TOTAL")+"");
                    Log.i("test", jsonObject2.getString("BUYER_TAOBAO")+"");
                }
                */
